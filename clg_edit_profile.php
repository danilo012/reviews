	...
	<!-- Register page -->
		...
		<div class="register-form-hide" style="display: block;">
			<div class="register-form-warp">
				...
				<form class="register-form animate" action="clg_edit_profile_ac.php" method="POST">
                            ...
                            <input type="text" placeholder="College name" name="clgname" required="required" value="<?php echo "$clgname"; ?>">

                            <select name="type">
                              <option value="<?php echo "$clgtype"; ?>"><?php echo "$clgtype"; ?></option>
	                          <option value="Government">Government</option>
	                          <option value="Private">Private</option>
                      		</select>

                            <input type="text" placeholder="Mobile no." name="mo" pattern="[0-9]{10}" required="required" value="<?php echo "$mo"; ?>">
