			...
			<div class="row">
				...
				<div class="col-lg-9 col-md-9">
								...
								if(isset($_SESSION['studentid']))
								{
									...
									$query="SELECT * FROM `student_details` WHERE studentid='$id' and collegeid='$clgid';";
									...
									{
										header("location:index.php?stu-write-rev=failed");
									}
								...
								{
									header("location:index.php?write-rev=failed");
								}
							?>
...
<div>
			<div class="register-form-warp">
				...
				<form class="register-form animate"  style="margin-top: 8px;" action="editreview_ac.php" method="POST">

						<?php
							require_once("connection.php");
							$query="SELECT * from college_review where collegeid=$clgid and studentid=$id;";
							$sql=mysqli_query($con,$query);
							if(mysqli_num_rows($sql) > 0)          
							{
								while($row = mysqli_fetch_assoc($sql))
					...
					<textarea placeholder="Write reviews here..." rows="3" name="reviews" required="required"><?php echo "$rev";?></textarea>
					...
					<div class="stars">
					      ...
					      <div style="margin-right: -100px; margin-top: -53px;">
					      	...
					      	<?php
					      		...
					      		{
					      			?>
					      			<input class="star star-5" id="star-5-2" type="radio" name="star" value="5" required="required" checked="checked"/>
					      		...
					      		{
					      			?>
					      			<input class="star star-4" id="star-4-2" type="radio" name="star" value="4" checked="checked" />
					      		...
					      		{
					      			?>
					      			<input class="star star-3" id="star-3-2" type="radio" name="star" value="3" checked="checked" />
					      		...
					      		{
					      			?>
					      			<input class="star star-2" id="star-2-2" type="radio" name="star" value="2" checked="checked" />
