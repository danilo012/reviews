								...
								<div id="id011" class="modal " style="display: block;">  
									<div class="login-msg">
										<div class="modal-content animate">
											...
											<h6 style="color: green;">Record deleted successfully!</h6>
											<div class="okbtn">
								...
								<div id="id011" class="modal " style="display: block;">  
									<div class="login-msg">
										<div class="modal-content animate">
											...
											<h6 style="color: green;">Student approved successfully!</h6>
											<div class="okbtn">
												<button class="btn btn-primary btn-lg btn-block" onclick="document.getElementById('id011').style.display='none'" style="width:auto;">Ok</button>
											</div>
										</div>
		...
		<div class="register-form-hide" style="display: block;">
			<div class="register-form-warp">
				...
				<form class="register-form animate">
					...
					<h3>Students remaining to approve</h3>
                        ...
                        <table>
                            <thead>
                            	...
                            	<?php
	                                    ...
	                                    $couquery="SELECT * FROM `student_details` where approved=0 and collegeid=$clgid;";
	                                        ...
	                                        while($row = mysqli_fetch_assoc($cousql))
	                                        {
	                                            ...
	                                            <tbody>
	                                                <tr>
                                                        ...
                                                        <td><a href="approvestu.php?id=<?php echo $id; ?>">Approve</a></td>
	                                                </tr>
	                                            </tbody>
                    ...
                    <h3 style="margin-top: 50px;">Approved students</h3>
					<hr style="border:2px solid #f1f1f1;">
                        ...
                        <table>
                            <thead>
                            	...
                            	<?php
	                                    ...
	                                    $no=0;
	                                    $clgid=$_SESSION['collegeid'];
	                                    $couquery="SELECT * FROM `student_details` where approved=1 and collegeid=$clgid;";
	                                    $cousql=mysqli_query($con,$couquery);
	                                    if(mysqli_num_rows($cousql) > 0)          
	                                    {
	                                        while($row = mysqli_fetch_assoc($cousql))
