...
<!-- Page -->
		...
		<div class="register-form-hide" style="display: block;">
			<div class="register-form-warp">
				...
				<form class="register-form animate">

					<h3>Student details</h3>
					<hr style="border:2px solid #f1f1f1;">

					<div class="table-responsive" style="margin-top: -10px; margin-bottom: 40px;">
                        <table>
                            	...
                            	<?php
	                                    ...
	                                    if(mysqli_num_rows($cousql) > 0)          
	                                    {
	                                        while($row = mysqli_fetch_assoc($cousql))
	                                        {
	                                            ...
	                                            <tr style="border-top: 1px solid #427eed;">
			                                        <th style="border-bottom: 1px solid white;">Email</th>
			                                       	<td class="info"><?php echo "$email";?></td>
			                                    </tr>
			                                    <tr>
			                                        <th style="border-bottom: 1px solid white;">First name</th>
			                                       	<td class="info"><?php echo "$fname";?></td>
			                                    </tr>
			                                    <tr>
			                                        <th style="border-bottom: 1px solid white;">Last type</th>
			                                       	<td class="info"><?php echo "$lname";?></td>
			                                    </tr>
			                                    <tr>
			                                        <th style="border-bottom: 1px solid white;">Gender</th>
			                                       	<td class="info"><?php echo "$gender";?></td>
			                                    </tr>
			                                    <tr>
			                                        <th style="border-bottom: 1px solid white;">Mobile no.</th>
			                                       	<td class="info"><?php echo "$mob";?></td>
			                                    </tr>
			                                    <tr>
			                                        <th style="border-bottom: 1px solid white;">Enrolment no.</th>
			                                       	<td class="info"><?php echo "$enno";?></td>
			                                    </tr>
			                                    <tr>
			                                        <th style="border-bottom: 1px solid white;">Semester</th>
			                                       	<td class="info"><?php echo "$sem";?></td>
			                                    </tr>
			                                    <tr>
			                                        <th style="border-bottom: 1px solid white;">College name</th>
			                                       	<td class="info"><?php echo "$clgname";?></td>
			                                    </tr>
			                                    <tr>
			                                        <th style="border-bottom: 1px solid white;">Course</th>
			                                       	<td class="info"><?php echo "$course";?></td>
			                                    </tr>
			                                    <tr>
			                                        <th style="border-bottom: 1px solid white;">Address</th>
	                                    ...
	                                    {
	                                    	?>
	                                    	<td style="border-bottom:1px solid white; color: grey; font-size: 25px;">No record found...</td>
	                                    	<?php
	                                    }
	                            ?>            
                        </table>
                    </div>
                    <a href="managestudent.php" style="background: #427eed; color: white; padding: 10px 20px;">Back</a>
			    </form>        
			</div>
	</div>
